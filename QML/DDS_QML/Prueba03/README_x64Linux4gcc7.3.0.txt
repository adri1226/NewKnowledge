...
data type OwnMessahe from own_topics.idl.
This example builds two applications, named own_topics_publisher and
own_topics_subscriber.
...
> make -f makefile_own_topics_x64Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_own_topics_x64Linux4gcc7.3.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the own_topics_publisher.cxx
file where it says:
...
> objs/x64Linux4gcc7.3.0/own_topics_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc7.3.0/own_topics_subscriber -d <domain_id> -s <sample_count>
