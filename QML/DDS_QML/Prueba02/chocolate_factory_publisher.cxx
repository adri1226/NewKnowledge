        ...
        const std::string& sensor_id)
{
    ...
    dds::topic::Topic<ChocolateLotState> lot_state_topic(participant, "ChocolateLotState");
    ...
    dds::pub::DataWriter<ChocolateLotState> lot_state_writer(publisher, lot_state_topic);
    ...
    for (unsigned int count = 0;
        ...
        rti::util::sleep(std::chrono::milliseconds(100));
    }
}
